...
var API = /** @class */ (function () {
    ...
    API.getSession = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(API.getPath("/files/3nodes.json"))];
                    case 1:
                        response = _a.sent();
    ...
    API.updateSession = function (state) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch(API.getPath("/updateSession"), requestOptions)];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new Error("Request failed with status code ".concat(response.status));
