...
export type BlockType = "image" | "video" | "paragraph" | "header" | "separator" | "checklist" | "picker" | "yesno" | "input-text" | "address" | "date" | "phone";
export type EmptyBlockData = {};
export type BlockDataType = ImageBlockData | VideoBlockData | ListBlockData | ButtonBlockData | TextBlockData | ChecklistBlockData | PickerBlockData | ToggleOptionBlockData | InputBlockData | ClickableOptionBlockData | AddressBlockData | DateBlockData | PhoneBlockData | EmptyBlockData;
